...
if __name__ == "__main__":
    # --- Argument Parsing --- 
    parser = argparse.ArgumentParser(description="Process image URLs from JSON files: count extensions, analyze invalid URLs, download images, and display samples.")
    ...
    # --- Processing --- 
    # Create an instance of ImageProcessor using parsed arguments
    processor = ImageProcessor(input_json_files, save_location)

    # Load data from the specified JSON file(s)
    processor.load_json()
